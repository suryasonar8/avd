...
export default function CheckoutPreviewPanel({
  globalSettings,
  setGlobalSettings,
  fetcher,
}) {
  ...
  return (
    ...
    >
      ...
      {/* Checkout mockup: image column left, form-field skeletons + checkbox right */}
      <div
        style={{
          border: "1px solid #E1E3E5",
          borderRadius: "8px",
      ...
      >
        ...
        {/* Checkout form skeletons + checkbox */}
        <div
          style={{
            flex: 1,
            display: "flex",
        ...
        >
          ...
          >
            ...
            <span style={{ fontSize: "14px", lineHeight: "1.4" }}>
              {t("termsAndConditions.defaults.checkoutCheckboxText")}
            </span>
          </div>
